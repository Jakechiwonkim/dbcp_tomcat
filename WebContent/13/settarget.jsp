...
<hr>
objectives : 목적<br>
<c:set var="objectives" value="<%= new java.util.HashMap() %>" />
<c:set target="${objectives }" property="jsp" value="jsp" />
<c:set target="${objectives }" property="spring" value="spring" />
<c:set target="${objectives }" property="spring_boot" value="spring boot" />
<c:set target="${objectives }" property="aspnetMVC" value="asp.net MVC" />

\${objectives.aspnetMVC} = ${objectives.aspnetMVC} <p>
<hr>
